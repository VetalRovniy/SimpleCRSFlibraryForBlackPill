...
static void packetChannels()
{
    ...
    Serial.print(crsf.getChannel(8));
     Serial.print(" CH9=");
    Serial.print(crsf.getChannel(9));
     Serial.print(" CH10=");
    Serial.print(crsf.getChannel(10));
     Serial.print(" CH11=");
    Serial.print(crsf.getChannel(11));
     Serial.print(" CH12=");
    Serial.print(crsf.getChannel(12));
     Serial.print(" CH13=");
    Serial.print(crsf.getChannel(13));
     Serial.print(" CH14=");
    Serial.print(crsf.getChannel(14));
     Serial.print(" CH15=");
    Serial.print(crsf.getChannel(15));
     Serial.print(" CH16=");
    Serial.print(crsf.getChannel(16));
    Serial.print("\n\r");
